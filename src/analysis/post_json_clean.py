...
output_folder = BASE_DIR / 'data' / 'result'
...
def restructure_to_nested(row):
    ...
    stats = {}
    stat_fields = [
        'total_reactions', 'like', 'support', 'love',
        'insight', 'celebrate', 'funny', 'comments', 'reposts'
    ]
...
for csv_file in input_folder.glob("*.csv"):
    ...
    try:
        ...
        json_output = output_folder / csv_file.with_suffix('.json').name
